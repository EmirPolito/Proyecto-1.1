...
export default function SignUpForm() {
  ...
  const baseSocial =
    "border-2 border-border dark:border-neutral-700 bg-background dark:bg-neutral-900 text-foreground dark:text-white rounded-lg w-full py-5 flex items-center justify-center transition-all duration-300 group";
  const liftHover =
    "hover:-translate-y-1 hover:scale-105 active:scale-98 hover:shadow-sm hover:bg-background dark:hover:bg-neutral-900";
  ...
  const validatePassword = (pass: string) => {
    ...
    return "Debe incluir al menos 2 números.";
  }
    return "";
  };
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      router.push("/menu"); // <-- REDIRECCIÓN FINAL
    }, 1500);
  };
          ...
          <div className="w-full max-w-lg">
            ...
            >
              ...
              <p className="text-sm opacity-85 transition-opacity">
                Bienvenido/a. Por favor, introduzca sus datos.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-9">
              ...
              >
                ...
                />
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-300 hover:text-white transition-all duration-300 hover:scale-110"
                  >
                    {showPassword ? (
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className={` cursor-pointer w-full py-1 font-semibold rounded-lg transition-all duration-300 mt-3 border-2 border-[var(--primary-2)] bg-[var(--primary-2)] text-[var(--primary-foreground)] ${liftHover} hover:bg-[var(--primary-2)] hover:text-[var(--primary-foreground)] hover:shadow-[0_0_12px_var(--mode-accent)] hover:scale-105 active:scale-95 ${
                  animate 
                    ? "opacity-100 translate-y-0"
...
//     if (!/[A-Z]/.test(pass)) {
//       return "Debe incluir almenos 1 letra mayúscula.";
//     }
//     if (pass.length < 7) {
//       return "Debe de tener mínimo 7 caracteres.";
//     }
//     if (!/[#_\-\/\*]/.test(pass)) {
//       return "Debe de incluir un carácter especial (# _ - / *)";
//     }
//     if ((pass.match(/\d/g) || []).length < 2) {
//       return "Debe incluir al menos 2 números.";
//     }
...
//   const handleSubmit = (e: React.FormEvent) => {
//     e.preventDefault();
//     const passError = validarContraseña(password);
//     setPasswordError(passError);
...
//                   onChange={(e) => setEmail(e.target.value)}
//                   required
//                     className="bg-background dark:bg-neutral-900 border-2 border-border dark:border-neutral-700 text-foreground dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-300 w-full px-3 py-2.5 rounded-lg transition-transform duration-200 ease-out hover:-translate-y-0.5 hover:scale-[1.02] hover:shadow-sm pr-20"
//                   />
//               </div>
...
//                     onChange={(e) => {
//                       setPassword(e.target.value);
//                       setPasswordError(validarContraseña(e.target.value));
//                     }}
//                     required
//                     className="bg-background dark:bg-neutral-900 border-2 border-border dark:border-neutral-700 text-foreground dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-300 w-full px-3 py-2.5 rounded-lg transition-transform duration-200 ease-out hover:-translate-y-0.5 hover:scale-[1.02] hover:shadow-sm pr-20"
//                   />
...
//                 type="submit"
//                 disabled={isLoading}
//                 className={`w-full py-1 font-semibold rounded-lg transition-all duration-300 mt-3 border-2 border-[var(--primary-2)] bg-[var(--primary-2)] text-[var(--primary-foreground)] ${liftHover} hover:bg-[var(--primary-2)] hover:text-[var(--primary-foreground)] hover:shadow-[0_0_12px_var(--mode-accent)] hover:scale-105 active:scale-95 ${
//                   animate
//                     ? "opacity-100 translate-y-0"
//                     : "opacity-0 translate-y-3"
//                 }`}
