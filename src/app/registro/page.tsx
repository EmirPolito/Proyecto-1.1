          ...
          <form onSubmit={handleSubmit} className="space-y-9">
            ...
            >
              ...
              <Input
                ...
                required
                className="bg-background dark:bg-neutral-900 border-2 border-border dark:border-neutral-700 text-foreground dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-300 px-3 py-2.5 rounded-lg focus:border-blue-500 transition-all duration-300 hover:border-gray-400 dark:hover:border-neutral-600 hover:shadow-sm hover:scale-105 focus:scale-105"
              />
            </div>
            ...
            >
              ...
              <div className="relative group">
                <Input
                  ...
                  required
                  className="bg-background dark:bg-neutral-900 border-2 border-border dark:border-neutral-700 text-foreground dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-300 w-full px-3 py-2.5 rounded-lg focus:border-blue-500 transition-all duration-300 hover:border-gray-400 dark:hover:border-neutral-600 hover:shadow-sm hover:scale-105 focus:scale-105 pr-20"
                />
