...
export default function WorldMap({
  ...
  const [encodedSvg, setEncodedSvg] = useState<string | null>(null);
  ...
  useEffect(() => {
    ...
    setEncodedSvg(encodeURIComponent(svgMap));
  }, [theme]);
  ...
  return (
    <div className="w-full aspect-[2/1] dark:bg-black  relative font-sans">
      {/* Evita hidratación hasta tener el SVG */}
      {encodedSvg && (
        <img
